                ...
                <div class="card-body p-4">
                    <form action="{{ route('addresses.update', $address) }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="ward_code" id="ward"
                                        class="form-select @error('ward_code') is-invalid @enderror" required>
                        ...
                        <div class="form-check mb-4">
                            ...
                            <label class="form-check-label" for="is_default">{{ __('messages.set_as_default') }}</label>
                        </div>
        ...
        fetch('/api/provinces')
            ...
            .then(data => {
                data.forEach(province => {
                    ...
                    if (province.id == {{ $address->province_id }}) option.selected = true;
            ...
            fetch(`/api/districts/${provinceId}`)
                ...
                .then(data => {
                    data.forEach(district => {
                        ...
                        if (district.id == {{ $address->district_id }}) option.selected = true;
            ...
            fetch(`/api/wards/${districtId}`)
                ...
                .then(data => {
                    data.forEach(ward => {
                        ...
                        if (ward.code == '{{ $address->ward_code }}') option.selected = true;
