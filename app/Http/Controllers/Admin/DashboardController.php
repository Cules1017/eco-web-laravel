...
class DashboardController extends Controller
{
    ...
    public function exportPdf(Request $request)
    {
        ...
        $pdf = Pdf::loadView('admin.dashboard.pdf', compact('order_count', 'revenue', 'top_products', 'user_count', 'date_from', 'date_to'));
        
        return $pdf->download('baocao_doanhthu_' . date('Ymd_Hi') . '.pdf');
    }
} 